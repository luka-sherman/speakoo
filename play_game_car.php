...
?>
    ...
    <body>
        ...
        function displayPopup() {
            if (currentWord >= wordsArray.length) {
                ...
                console.log("final result is : " + toReturn);
        ...
        function displayResult() {
            ...
            resultVar += "Total: " + currentPoint + "pts</br>";
        ...
        function populatePopup() {
            ...
            toDisplay += '<input type = "radio" name = "answer" id="delete" value="$$$"><label for = "delete"> [delete] ' + " </label> </br>"
    ...
    <script>
        ...
        var hud = {
            ...
            current_Point: {
                value: null,
                dom: Dom.get('current_Point_value')
            },
            last_lap_time: {
                value: null,
