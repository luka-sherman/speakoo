...
function startRecordingAfterActive() {
    ...
    document.getElementById("dataKeyText").innerHTML = "<br>Your Session ID:<br><a target=\"_blank\" href=\""+currentFeedbackPage+".php?dataKey="+dataKey+"\" >" + dataKey + "</a><br><br><b>Please wait a couple of minutes for the video to upload. Thank you for your patience!</b>";
...
function progressing() {
    ...
    if (!finished && curPercent < 83) {
        ...
        $("#progresstext").html("Complete <br> Your Session ID:<br>"+dataKey+"<br>Please ");
...
MyRecording.prototype.uploadFileToServer = function(blob_slice) {
  ...
  request.open('POST', "response.php?action=upload&dataKey="+dataKey);
